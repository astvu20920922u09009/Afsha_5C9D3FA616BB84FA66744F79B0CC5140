"""Implement a class called BankAccount that represents a bankaccount. The class should have private attributes for account number, account holder name and account balance. Include methods to deposit money, withdraw money and display the account balance. Ensure that the account balance cannot be accessed directly from outside the class. Write a program to create an intance of the BankAccount class and test the deposit and withdrawal functionality"""
...
account=BankAccount(account_number="987654321",  
                    account_holder_name="Afsha Banu",
